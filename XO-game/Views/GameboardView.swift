...
public class GameboardView: UIView {
    ...
    internal struct Constants {
        static let lineColorBlack: UIColor = .black
        static let lineColorGreen: UIColor = .green
    ...
    public override func draw(_ rect: CGRect) {
        super.draw(rect)
        Constants.lineColorBlack.setStroke()
    ...
    // MARK: - UI
     ...
     func drawColumnLines(for rect: CGRect) {
     ...
     func drawRowLines(for rect: CGRect) {
